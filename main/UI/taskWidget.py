...
"}")
        ...
        self.taskDescEdit = QtWidgets.QLineEdit(self.page_2)
        self.taskDescEdit.setMinimumSize(QtCore.QSize(0, 70))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.taskDescEdit.setFont(font)
        self.taskDescEdit.setObjectName("taskDescEdit")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.taskDescEdit)
        ...
        self.horizontalLayout_5.addWidget(self.yesRadioButton)
        ...
        self.horizontalLayout_5.addWidget(self.noRadioButton)
        self.formLayout.setLayout(3, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_5)
        self.stageSpinBox = QtWidgets.QSpinBox(self.page_2)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        self.stageSpinBox.setFont(font)
        self.stageSpinBox.setMinimum(1)
        self.stageSpinBox.setMaximum(10)
        self.stageSpinBox.setObjectName("stageSpinBox")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.stageSpinBox)
...
"}")
    ...
    def retranslateUi(self, taskWidget):
        ...
        self.label_5.setText(_translate("taskWidget", "分阶段："))
        self.label_6.setText(_translate("taskWidget", "阶段数："))
        ...
        self.yesRadioButton.setText(_translate("taskWidget", "是"))
        self.noRadioButton.setText(_translate("taskWidget", "否"))
