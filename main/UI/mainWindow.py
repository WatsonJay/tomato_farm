...
"")
        ...
        self.sizePushButton = QtWidgets.QPushButton(self.windowBar)
        self.sizePushButton.setMinimumSize(QtCore.QSize(16, 16))
        self.sizePushButton.setMaximumSize(QtCore.QSize(16, 16))
...
"}\n"
"")
        self.sizePushButton.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/maxSize.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.sizePushButton.setIcon(icon1)
        self.sizePushButton.setIconSize(QtCore.QSize(10, 10))
        self.sizePushButton.setObjectName("sizePushButton")
        self.horizontalLayout.addWidget(self.sizePushButton)
...
"}")
        ...
        self.toolWidget.setMaximumSize(QtCore.QSize(150, 16777215))
        font = QtGui.QFont()
...
"}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon/setting.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.settingButton.setIcon(icon8)
...
"}")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.introButton.setIcon(icon9)
        ...
        self.stackedWidget.setMinimumSize(QtCore.QSize(886, 0))
        ...
        self.DoingWidget.setMinimumSize(QtCore.QSize(0, 0))
        self.DoingWidget.setMaximumSize(QtCore.QSize(16777215, 70))
...
"}")
        ...
        self.horizontalLayout_4.setContentsMargins(8, 0, 18, 0)
...
"}")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icon/redo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.redoTimerButton.setIcon(icon10)
...
"}")
        ...
        self.startTimerButton.setIcon(icon11)
...
"}")
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icon/pause.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pauseTimerButton.setIcon(icon12)
...
"}")
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icon/stop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.stopTimerButton.setIcon(icon13)
...
"}")
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icon/miniBar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.miniSizeButton.setIcon(icon14)
