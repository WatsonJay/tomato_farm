...
"}")
        ...
        self.userInfoButton = QtWidgets.QPushButton(self.toolWidget)
        self.userInfoButton.setMinimumSize(QtCore.QSize(0, 30))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.userInfoButton.setIcon(icon3)
        self.userInfoButton.setCheckable(True)
        self.userInfoButton.setAutoExclusive(True)
        self.userInfoButton.setObjectName("userInfoButton")
        self.verticalLayout_3.addWidget(self.userInfoButton)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/mession.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icon/market.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.marketButton.setIcon(icon5)
...
"}")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.introButton.setIcon(icon7)
...
"}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon/redo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.redoTimerButton.setIcon(icon8)
...
"}")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/play.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.startTimerButton.setIcon(icon9)
...
"}")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icon/pause.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pauseTimerButton.setIcon(icon10)
...
"}")
        ...
        self.stopTimerButton.setIcon(icon11)
...
"}")
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icon/miniBar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.miniSizeButton.setIcon(icon12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.userInfoButton.setText(_translate("MainWindow", "农场统计"))
