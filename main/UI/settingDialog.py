...
"}")
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.gitNameEdit)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.gitPasswordEdit)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.gitProgramEdit)
        ...
        self.radioButton_2 = QtWidgets.QRadioButton(self.gitTab)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        self.radioButton_2.setFont(font)
        self.radioButton_2.setObjectName("radioButton_2")
        self.horizontalLayout_7.addWidget(self.radioButton_2)
        self.radioButton = QtWidgets.QRadioButton(self.gitTab)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(10)
    ...
    def retranslateUi(self, settingDialog):
        ...
        self.radioButton_2.setText(_translate("settingDialog", "启用"))
        self.radioButton.setText(_translate("settingDialog", "禁用"))
