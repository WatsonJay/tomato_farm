...
"}")
        ...
        self.fileTableWidget.setMinimumSize(QtCore.QSize(708, 0))
...
"}")
        ...
        self.fileTableWidget.horizontalHeader().setMinimumSectionSize(50)
...
"}")
        ...
        self.seachCountWidget = QtWidgets.QWidget(self.widget_2)
        self.seachCountWidget.setObjectName("seachCountWidget")
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout(self.seachCountWidget)
        self.horizontalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.label = QtWidgets.QLabel(self.seachCountWidget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.horizontalLayout_8.addWidget(self.label)
        self.searchCountLabel = QtWidgets.QLabel(self.seachCountWidget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        self.searchCountLabel.setFont(font)
        self.searchCountLabel.setText("")
        self.searchCountLabel.setObjectName("searchCountLabel")
        self.horizontalLayout_8.addWidget(self.searchCountLabel)
        self.label_3 = QtWidgets.QLabel(self.seachCountWidget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_8.addWidget(self.label_3)
        self.horizontalLayout_7.addWidget(self.seachCountWidget)
        ...
        self.windowCountLabel = QtWidgets.QLabel(self.widget_2)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        self.windowCountLabel.setFont(font)
        self.windowCountLabel.setText("")
        self.windowCountLabel.setObjectName("windowCountLabel")
        self.horizontalLayout_7.addWidget(self.windowCountLabel)
        ...
        self.articleCountLabel = QtWidgets.QLabel(self.widget_2)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        self.articleCountLabel.setFont(font)
        self.articleCountLabel.setText("")
        self.articleCountLabel.setObjectName("articleCountLabel")
        self.horizontalLayout_7.addWidget(self.articleCountLabel)
    ...
    def retranslateUi(self, memoWidget):
        ...
        item.setText(_translate("memoWidget", "标题"))
        ...
        self.label.setText(_translate("memoWidget", "搜索结果：共"))
        self.label_3.setText(_translate("memoWidget", "处  |"))
        self.label_6.setText(_translate("memoWidget", "打开文章数："))
        self.label_9.setText(_translate("memoWidget", "个  |"))
        self.label_4.setText(_translate("memoWidget", "当前文章统计："))
        self.label_8.setText(_translate("memoWidget", "字"))
