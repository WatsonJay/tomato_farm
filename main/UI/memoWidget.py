...
"}")
        ...
        self.showMenuButton = QtWidgets.QPushButton(self.widget)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/down.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.showMenuButton.setIcon(icon)
        self.showMenuButton.setIconSize(QtCore.QSize(8, 8))
...
"}")
        ...
        self.fontComboBox.setMinimumSize(QtCore.QSize(150, 0))
        self.fontComboBox.setMaximumSize(QtCore.QSize(16777215, 25))
        self.fontComboBox.setObjectName("fontComboBox")
        self.horizontalLayout_2.addWidget(self.fontComboBox)
        self.sizeComboBox = QtWidgets.QComboBox(self.widget_3)
        self.sizeComboBox.setMinimumSize(QtCore.QSize(60, 25))
        self.sizeComboBox.setMaximumSize(QtCore.QSize(60, 25))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/bold.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bordButton.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/Italic.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ItalicButton.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/underline.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.underlineButton.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icon/leftJust.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.leftJustButton.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icon/center.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.centerButton.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/rightJust.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rightJustButton.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon/fontColor.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fontColorButton.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/singlePen.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.signlePenButton.setIcon(icon9)
        ...
        self.searchChangeButton.setIcon(icon10)
...
"}")
    ...
    def retranslateUi(self, memoWidget):
        ...
        self.sizeComboBox.setToolTip(_translate("memoWidget", "字体大小"))
