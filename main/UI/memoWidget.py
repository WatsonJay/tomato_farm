...
class Ui_memoWidget(object):
    def setupUi(self, memoWidget):
        ...
        self.widget_4 = QtWidgets.QWidget(memoWidget)
        self.widget_4.setMaximumSize(QtCore.QSize(340, 16777215))
        ...
        self.calendarWidget.setMaximumSize(QtCore.QSize(340, 16777215))
        font = QtGui.QFont()
...
"}")
        ...
        self.treeWidget.setMaximumSize(QtCore.QSize(340, 16777215))
        font = QtGui.QFont()
